...
public class BlogController {
    ...
    public String getBlogBoardList(Model model , @Valid CommentCreateForm commentCreateForm, @PathVariable("bno") int bno , Principal principal){
    ...
    public String blogBoardSearch(Model model, @Valid BoardSearchForm boardSearchForm, BindingResult bindingResult, Principal principal ,
                                    @RequestParam(value = "page", defaultValue = "0") int pageNumber, @RequestParam(value = "size", defaultValue = "4") int pageSize){
