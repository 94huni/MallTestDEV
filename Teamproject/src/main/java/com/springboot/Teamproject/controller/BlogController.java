...
public class BlogController {
    ...
    public String blogBoardModify(@Valid BoardCreateForm boardCreateForm,BindingResult bindingResult,Principal principal,@PathVariable Integer bno) throws IOException {
